...
input_query.add_argument(name='cmd1', type=str, location='json', required=True, nullable=False)
input_query.add_argument(name='value1', type=str, location='json', required=True, nullable=False)
input_query.add_argument(name='cmd2', type=str, location='json', required=True, nullable=False)
